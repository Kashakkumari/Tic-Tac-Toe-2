...
function logicOne() {
           ...
           // if ((a != 0)&&(b != 0)&&(c != 0)&&(d != 0)&&(e != 0)&&(f != 0)&&(g != 0)&&(h != 0)&&(i != 0)&&(all == 0)) all = 3;
	        checkTied();
		   if(  myLogic >5     && myLogic <=8 && all == 0) all=3;
}


function checkTied(){
	        if((a==b && b!=c)&& (a!=b && b==c)&& (a==c && a!=c)) myLogic ++;
	        if((d==e && d!=f)&& (d!=e && e==f)&& (d==f && d!=f)) myLogic ++;
	        if((g==h && h!=i)&& (g!=h && h==i)&& (g==i && g!=i)) myLogic ++;
			
	        if((a==d && d!=g)&& (a!=d && d==g)&& (a==g && a!=g)) myLogic ++;
	        if((b==e && e!=h)&& (b!=e && e==h)&& (b==h && b!=h)) myLogic ++;
		    if((c==f && f!=i)&& (c!=f && f==i)&& (c==i && c!=i)) myLogic ++;
						
			if((a==e && e!=i)&& (a!=e && e==i)&& (a==i && a!=i)) myLogic ++;
			if((c==e && e!=g)&& (c!=e && e==g)&& (c==g && c!=g)) myLogic ++;
...
function User_Choice(chName) {
                    ...
                    if (ok==0)taken();
                    process();
                    if ((all==0)&&(pause==0)) Computer_Choice();
                          }
            }
...
function process() {
                   ...
                   if (all==2){ alert("Computer won!"); ls++; }
                   if (all==3){ alert("Opps! We tied."); ts++; }
                   if (all!=0) {
